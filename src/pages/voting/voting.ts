...
export class VotingPage {
  ...
  gdtMemberNames: string[] = ['bioly','cc001','corsaro','dakk','5an1ty','eclipsun','forrest','goldeneye','gr33ndrag0n','grumlin','hagie','hmachado','joel','kushed','liskgate','liskit','4miners.net','mrv','nerigal','ntelo','ondin','philhellmuth','punkrock','redsn0w','sgdias','slasheks','splatters','joo5ty','tembo','vekexasia','vi1son','gdtpool'];
  ...
  voteGDT() {
  	...
  	if (remaining < this.updateVotesArray.length-1) {
  		this.showToast(`Not enought free slots to vote all GDT. Have ${remaining} and need ${this.updateVotesArray.length-1}.`);
  		this.updateVotesArray = [''];
  		this.updateVotesNamesArray = [''];
  	} else {
